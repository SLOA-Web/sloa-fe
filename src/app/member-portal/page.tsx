  ...
  const recentActivities = [
    {
      ...
      description:
        "Your application for membership has been submitted successfully",
      time: "2 hours ago",
      status: "pending",
    },
    {
            ...
            <div className="card-content">
              <div className="space-y-3">
                {recentActivities.map((activity) => (
                  <div
                    key={activity.id}
                    className="flex items-start space-x-3 p-3 rounded-lg hover:bg-accent transition-colors duration-200"
                  >
                    <div
